import {
  DomSanitizer
} from "./chunk-Z5CK5QWE.js";
import "./chunk-FO4WAP7J.js";
import {
  DOCUMENT,
  Location,
  NgClass,
  isPlatformBrowser
} from "./chunk-FUIOLA5V.js";
import {
...
// node_modules/ngx-touch-keyboard/fesm2022/ngx-touch-keyboard.mjs
var _forTrack0 = ($index, $item) => $item[0];
var _c02 = (a0) => [a0];
function NgxTouchKeyboardComponent_For_2_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "button", 3);
    ɵɵlistener("pointerup", function NgxTouchKeyboardComponent_For_2_For_2_Template_button_pointerup_0_listener($event) {
      const key_r2 = ɵɵrestoreView(_r1).$implicit;
      const ctx_r2 = ɵɵnextContext(2);
      return ɵɵresetView(ctx_r2.handleButtonUp(key_r2, $event));
    })("pointerdown", function NgxTouchKeyboardComponent_For_2_For_2_Template_button_pointerdown_0_listener($event) {
      const key_r2 = ɵɵrestoreView(_r1).$implicit;
      const ctx_r2 = ɵɵnextContext(2);
      return ɵɵresetView(ctx_r2.handleButtonDown(key_r2, $event));
    })("pointercancel", function NgxTouchKeyboardComponent_For_2_For_2_Template_button_pointercancel_0_listener($event) {
      const key_r2 = ɵɵrestoreView(_r1).$implicit;
      const ctx_r2 = ɵɵnextContext(2);
      return ɵɵresetView(ctx_r2.handleButtonUp(key_r2, $event));
    });
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = ɵɵnextContext(2);
    ɵɵproperty("name", key_r2)("dir", ctx_r2.locale.dir)("ngClass", ɵɵpureFunction1(5, _c02, ctx_r2.getButtonClass(key_r2)))("innerHtml", ctx_r2.getButtonDisplayName(key_r2), ɵɵsanitizeHtml);
    ɵɵattribute("data-layout", ctx_r2.layoutMode);
  }
}
function NgxTouchKeyboardComponent_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "div", 1);
    ɵɵrepeaterCreate(1, NgxTouchKeyboardComponent_For_2_For_2_Template, 1, 7, "button", 2, ɵɵrepeaterTrackByIdentity);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
var layouts$6 = {
  text_alphabetic: [["q", "w", "e", "r", "t", "y", "u", "i", "o", "p"], ["a", "s", "d", "f", "g", "h", "j", "k", "l"], ["{shift}", "z", "x", "c", "v", "b", "n", "m", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  text_shift: [["Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P"], ["A", "S", "D", "F", "G", "H", "J", "K", "L"], ["{shift}", "Z", "X", "C", "V", "B", "N", "M", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  text_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["-", "/", ":", ";", "(", ")", "$", "&", "@", '"'], ["{symbolic}", ".", ",", "?", "!", "'", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  text_symbolic: [["[", "]", "{", "}", "#", "%", "^", "*", "+", "="], ["_", "\\", "|", "~", "<", ">", "€", "£", "¥", "•"], ["{numeric}", ".", ",", "?", "!", "'", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  search_alphabetic: [["q", "w", "e", "r", "t", "y", "u", "i", "o", "p"], ["a", "s", "d", "f", "g", "h", "j", "k", "l"], ["{shift}", "z", "x", "c", "v", "b", "n", "m", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  search_shift: [["Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P"], ["A", "S", "D", "F", "G", "H", "J", "K", "L"], ["{shift}", "Z", "X", "C", "V", "B", "N", "M", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  search_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["-", "/", ":", ";", "(", ")", "$", "&", "@", '"'], ["{symbolic}", ".", ",", "?", "!", "'", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  search_symbolic: [["[", "]", "{", "}", "#", "%", "^", "*", "+", "="], ["_", "\\", "|", "~", "<", ">", "€", "£", "¥", "•"], ["{numeric}", ".", ",", "?", "!", "'", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  email_alphabetic: [["q", "w", "e", "r", "t", "y", "u", "i", "o", "p"], ["a", "s", "d", "f", "g", "h", "j", "k", "l"], ["{shift}", "z", "x", "c", "v", "b", "n", "m", "{backspace}"], ["{numeric}", "@", "{space}", ".", "{done}"]],
  email_shift: [["Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P"], ["A", "S", "D", "F", "G", "H", "J", "K", "L"], ["{shift}", "Z", "X", "C", "V", "B", "N", "M", "{backspace}"], ["{numeric}", "@", "{space}", ".", "{done}"]],
  email_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["$", "!", "~", "&", "=", "#", "[", "]"], ["{symbolic}", ".", "_", "-", "+", "{backspace}"], ["{alphabetic}", "@", "{space}", ".", "{done}"]],
  email_symbolic: [["`", "|", "{", "}", "?", "%", "^", "*", "/", "'"], ["$", "!", "~", "&", "=", "#", "[", "]"], ["{numeric}", ".", "_", "-", "+", "{backspace}"], ["{alphabetic}", "@", "{space}", ".", "{done}"]],
  url_alphabetic: [["q", "w", "e", "r", "t", "y", "u", "i", "o", "p"], ["a", "s", "d", "f", "g", "h", "j", "k", "l"], ["{shift}", "z", "x", "c", "v", "b", "n", "m", "{backspace}"], ["{numeric}", "/", ".com", ".", "{done}"]],
  url_shift: [["Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P"], ["A", "S", "D", "F", "G", "H", "J", "K", "L"], ["{shift}", "Z", "X", "C", "V", "B", "N", "M", "{backspace}"], ["{numeric}", "/", ".com", ".", "{done}"]],
  url_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["@", "&", "%", "?", ",", "=", "[", "]"], ["{symbolic}", "_", ":", "-", "+", "{backspace}"], ["{alphabetic}", "/", ".com", ".", "{done}"]],
  url_symbolic: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["*", "$", "#", "!", "'", "^", "[", "]"], ["{numeric}", "~", ";", "(", ")", "{backspace}"], ["{alphabetic}", "/", ".com", ".", "{done}"]],
  numeric_default: [["1", "2", "3"], ["4", "5", "6"], ["7", "8", "9"], ["0", "{backspace}"]],
  decimal_default: [["1", "2", "3"], ["4", "5", "6"], ["7", "8", "9"], [".", "0", "{backspace}"]],
  tel_default: [["1", "2", "3", "*"], ["4", "5", "6", "#"], ["7", "8", "9", "+"], ["0", "{backspace}"]]
};
var display$6 = {
  "{done}": fnDisplay.DONE,
...
var layouts$4 = {
  text_alphabetic: [["ض", "ص", "ق", "ف", "غ", "ع", "ه", "خ", "ح", "ج", "چ"], ["ش", "س", "ی", "ب", "ل", "ا", "ت", "ن", "م", "ک", "گ"], ["ظ", "ط", "ژ", "ز", "ر", "ذ", "د", "پ", "و", "ث", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  text_numeric: [["۱", "۲", "۳", "۴", "۵", "۶", "۷", "۸", "۹", "۰"], ["-", "/", ":", "؛", ")", "(", "$", "@", "»", "«"], ["{symbolic}", ".", "،", "؟", "!", "٫", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  text_symbolic: [["]", "[", "}", "{", "#", "%", "^", "*", "+", "="], ["_", "\\", "|", "~", ">", "<", "&", "•", "‘", "“"], ["{numeric}", ".", "،", "؟", "!", "٬", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  search_alphabetic: [["ض", "ص", "ق", "ف", "غ", "ع", "ه", "خ", "ح", "ج", "چ"], ["ش", "س", "ی", "ب", "ل", "ا", "ت", "ن", "م", "ک", "گ"], ["ظ", "ط", "ژ", "ز", "ر", "ذ", "د", "پ", "و", "ث", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  search_numeric: [["۱", "۲", "۳", "۴", "۵", "۶", "۷", "۸", "۹", "۰"], ["-", "/", ":", "؛", ")", "(", "$", "@", "»", "«"], ["{symbolic}", ".", "،", "؟", "!", "٫", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  search_symbolic: [["]", "[", "}", "{", "#", "%", "^", "*", "+", "="], ["_", "\\", "|", "~", ">", "<", "&", "•", "‘", "“"], ["{numeric}", ".", "،", "؟", "!", "٬", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  email_alphabetic: [["ض", "ص", "ق", "ف", "غ", "ع", "ه", "خ", "ح", "ج", "چ"], ["ش", "س", "ی", "ب", "ل", "ا", "ت", "ن", "م", "ک", "گ"], ["ظ", "ط", "ژ", "ز", "ر", "ذ", "د", "پ", "و", "ث", "{backspace}"], ["{numeric}", "@", "{space}", ".", "{done}"]],
  email_numeric: [["۱", "۲", "۳", "۴", "۵", "۶", "۷", "۸", "۹", "۰"], ["$", "!", "~", "&", "=", "#", "]", "["], ["{symbolic}", ".", "_", "-", "+", "{backspace}"], ["{alphabetic}", "@", "{space}", ".", "{done}"]],
  email_symbolic: [["`", "|", "{", "}", "?", "%", "^", "*", "/", "'"], ["$", "!", "~", "&", "=", "#", "]", "["], ["{numeric}", ".", "_", "-", "+", "{backspace}"], ["{alphabetic}", "@", "{space}", ".", "{done}"]],
  url_alphabetic: [["ض", "ص", "ق", "ف", "غ", "ع", "ه", "خ", "ح", "ج", "چ"], ["ش", "س", "ی", "ب", "ل", "ا", "ت", "ن", "م", "ک", "گ"], ["ظ", "ط", "ژ", "ز", "ر", "ذ", "د", "پ", "و", "ث", "{backspace}"], ["{numeric}", "/", ".com", ".", "{done}"]],
  url_numeric: [["۱", "۲", "۳", "۴", "۵", "۶", "۷", "۸", "۹", "۰"], ["@", "&", "%", "?", ",", "=", "]", "["], ["{symbolic}", "_", ":", "-", "+", "{backspace}"], ["{alphabetic}", "/", ".com", ".", "{done}"]],
  url_symbolic: [["۱", "۲", "۳", "۴", "۵", "۶", "۷", "۸", "۹", "۰"], ["*", "$", "#", "!", "'", "^", "]", "["], ["{numeric}", "~", ";", ")", "(", "{backspace}"], ["{alphabetic}", "/", ".com", ".", "{done}"]],
  numeric_default: [["۱", "۲", "۳"], ["۴", "۵", "۶"], ["۷", "۸", "۹"], ["۰", "{backspace}"]],
  decimal_default: [["۱", "۲", "۳"], ["۴", "۵", "۶"], ["۷", "۸", "۹"], ["٫", "۰", "{backspace}"]],
  tel_default: [["۱", "۲", "۳", "*"], ["۴", "۵", "۶", "#"], ["۷", "۸", "۹", "+"], ["۰", "{backspace}"]]
};
var display$4 = {
  "{done}": fnDisplay.DONE,
  "{backspace}": fnDisplay.BACKSPACE,
...
var layouts$3 = {
  text_alphabetic: [["ק", "ר", "א", "ט", "ו", "ן", "ם", "פ"], ["ש", "ד", "ג", "כ", "ע", "י", "ח", "ל", "ך", "ף"], ["ז", "ס", "ב", "ה", "נ", "מ", "צ", "ת", "ץ", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  text_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["-", "/", ":", ";", "(", ")", "₪", "@", '"', "'"], ["{symbolic}", ".", ",", "?", "!", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  text_symbolic: [["[", "]", "{", "}", "#", "%", "^", "*", "+", "="], ["_", "\\", "|", "~", "<", ">", "€", "$", "&", "•"], ["{numeric}", ".", ",", "?", "!", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  search_alphabetic: [["ק", "ר", "א", "ט", "ו", "ן", "ם", "פ"], ["ש", "ד", "ג", "כ", "ע", "י", "ח", "ל", "ך", "ף"], ["ז", "ס", "ב", "ה", "נ", "מ", "צ", "ת", "ץ", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  search_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["-", "/", ":", ";", "(", ")", "₪", "@", '"', "'"], ["{symbolic}", ".", ",", "?", "!", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  search_symbolic: [["[", "]", "{", "}", "#", "%", "^", "*", "+", "="], ["_", "\\", "|", "~", "<", ">", "€", "$", "&", "•"], ["{numeric}", ".", ",", "?", "!", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  email_alphabetic: [["ק", "ר", "א", "ט", "ו", "ן", "ם", "פ"], ["ש", "ד", "ג", "כ", "ע", "י", "ח", "ל", "ך", "ף"], ["ז", "ס", "ב", "ה", "נ", "מ", "צ", "ת", "ץ", "{backspace}"], ["{numeric}", "@", "{space}", ".", "{done}"]],
  email_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["₪", "!", "~", "&", "=", "#", "]", "["], ["{symbolic}", ".", "_", "-", "+", "{backspace}"], ["{alphabetic}", "@", "{space}", ".", "{done}"]],
  email_symbolic: [["`", "|", "{", "}", "?", "%", "^", "*", "/", "'"], ["₪", "!", "~", "&", "=", "#", "]", "["], ["{numeric}", ".", "_", "-", "+", "{backspace}"], ["{alphabetic}", "@", "{space}", ".", "{done}"]],
  url_alphabetic: [["ק", "ר", "א", "ט", "ו", "ן", "ם", "פ"], ["ש", "ד", "ג", "כ", "ע", "י", "ח", "ל", "ך", "ף"], ["ז", "ס", "ב", "ה", "נ", "מ", "צ", "ת", "ץ", "{backspace}"], ["{numeric}", "/", ".com", ".", "{done}"]],
  url_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["@", "&", "%", "?", ",", "=", "]", "["], ["{symbolic}", "_", ":", "-", "+", "{backspace}"], ["{alphabetic}", "/", ".com", ".", "{done}"]],
  url_symbolic: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["*", "₪", "#", "!", "'", "^", "]", "["], ["{numeric}", "~", ";", ")", "(", "{backspace}"], ["{alphabetic}", "/", ".com", ".", "{done}"]],
  numeric_default: [["1", "2", "3"], ["4", "5", "6"], ["7", "8", "9"], ["0", "{backspace}"]],
  decimal_default: [["1", "2", "3"], ["4", "5", "6"], ["7", "8", "9"], [".", "0", "{backspace}"]],
...
var layouts$2 = {
  text_alphabetic: [["ქ", "წ", "ე", "რ", "ტ", "ყ", "უ", "ი", "ო", "პ"], ["ა", "ს", "დ", "ფ", "გ", "ჰ", "ჯ", "კ", "ლ"], ["{shift}", "ზ", "ხ", "ც", "ვ", "ბ", "ნ", "მ", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  text_shift: [["ქ", "ჭ", "ე", "ღ", "თ", "ყ", "უ", "ი", "ო", "პ"], ["ა", "შ", "დ", "ფ", "გ", "ჰ", "ჟ", "კ", "₾"], ["{shift}", "ძ", "ხ", "ჩ", "ვ", "ბ", "ნ", "მ", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  text_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["-", "/", ":", ";", "(", ")", "$", "&", "@", '"'], ["{symbolic}", ".", ",", "?", "!", "'", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  text_symbolic: [["[", "]", "{", "}", "#", "%", "^", "*", "+", "="], ["_", "\\", "|", "~", "<", ">", "€", "£", "¥", "•"], ["{numeric}", ".", ",", "?", "!", "'", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  search_alphabetic: [["ქ", "წ", "ე", "რ", "ტ", "ყ", "უ", "ი", "ო", "პ"], ["ა", "ს", "დ", "ფ", "გ", "ჰ", "ჯ", "კ", "ლ"], ["{shift}", "ზ", "ხ", "ც", "ვ", "ბ", "ნ", "მ", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  search_shift: [["ქ", "ჭ", "ე", "ღ", "თ", "ყ", "უ", "ი", "ო", "პ"], ["ა", "შ", "დ", "ფ", "გ", "ჰ", "ჟ", "კ", "₾"], ["{shift}", "ძ", "ხ", "ჩ", "ვ", "ბ", "ნ", "მ", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  search_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["-", "/", ":", ";", "(", ")", "$", "&", "@", '"'], ["{symbolic}", ".", ",", "?", "!", "'", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  search_symbolic: [["[", "]", "{", "}", "#", "%", "^", "*", "+", "="], ["_", "\\", "|", "~", "<", ">", "€", "£", "¥", "•"], ["{numeric}", ".", ",", "?", "!", "'", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  email_alphabetic: [["ქ", "წ", "ე", "რ", "ტ", "ყ", "უ", "ი", "ო", "პ"], ["ა", "ს", "დ", "ფ", "გ", "ჰ", "ჯ", "კ", "ლ"], ["{shift}", "ზ", "ხ", "ც", "ვ", "ბ", "ნ", "მ", "{backspace}"], ["{numeric}", "@", "{space}", ".", "{done}"]],
  email_shift: [["ქ", "ჭ", "ე", "ღ", "თ", "ყ", "უ", "ი", "ო", "პ"], ["ა", "შ", "დ", "ფ", "გ", "ჰ", "ჟ", "კ", "₾"], ["{shift}", "ძ", "ხ", "ჩ", "ვ", "ბ", "ნ", "მ", "{backspace}"], ["{numeric}", "@", "{space}", ".", "{done}"]],
  email_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["$", "!", "~", "&", "=", "#", "[", "]"], ["{symbolic}", ".", "_", "-", "+", "{backspace}"], ["{alphabetic}", "@", "{space}", ".", "{done}"]],
  email_symbolic: [["`", "|", "{", "}", "?", "%", "^", "*", "/", "'"], ["$", "!", "~", "&", "=", "#", "[", "]"], ["{numeric}", ".", "_", "-", "+", "{backspace}"], ["{alphabetic}", "@", "{space}", ".", "{done}"]],
  url_alphabetic: [["ქ", "წ", "ე", "რ", "ტ", "ყ", "უ", "ი", "ო", "პ"], ["ა", "ს", "დ", "ფ", "გ", "ჰ", "ჯ", "კ", "ლ"], ["{shift}", "ზ", "ხ", "ც", "ვ", "ბ", "ნ", "მ", "{backspace}"], ["{numeric}", "/", ".com", ".", "{done}"]],
  url_shift: [["ქ", "ჭ", "ე", "ღ", "თ", "ყ", "უ", "ი", "ო", "პ"], ["ა", "შ", "დ", "ფ", "გ", "ჰ", "ჟ", "კ", "₾"], ["{shift}", "ძ", "ხ", "ჩ", "ვ", "ბ", "ნ", "მ", "{backspace}"], ["{numeric}", "/", ".com", ".", "{done}"]],
  url_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["@", "&", "%", "?", ",", "=", "[", "]"], ["{symbolic}", "_", ":", "-", "+", "{backspace}"], ["{alphabetic}", "/", ".com", ".", "{done}"]],
  url_symbolic: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["*", "$", "#", "!", "'", "^", "[", "]"], ["{numeric}", "~", ";", "(", ")", "{backspace}"], ["{alphabetic}", "/", ".com", ".", "{done}"]],
  numeric_default: [["1", "2", "3"], ["4", "5", "6"], ["7", "8", "9"], ["0", "{backspace}"]],
  decimal_default: [["1", "2", "3"], ["4", "5", "6"], ["7", "8", "9"], [".", "0", "{backspace}"]],
...
var layouts$1 = {
  text_alphabetic: [["й", "ц", "у", "к", "е", "н", "г", "ш", "щ", "з", "х", "ъ"], ["ф", "ы", "в", "а", "п", "р", "о", "л", "д", "ж", "э"], ["{shift}", "я", "ч", "с", "м", "и", "т", "ь", "б", "ю", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  text_shift: [["Й", "Ц", "У", "К", "Е", "Н", "Г", "Ш", "Щ", "З", "Х", "Ъ"], ["Ф", "Ы", "В", "А", "П", "Р", "О", "Л", "Д", "Ж", "З"], ["{shift}", "Я", "Ч", "С", "М", "И", "Т", "Ь", "Б", "Ю", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  text_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["-", "/", ":", ";", "(", ")", "$", "&", "@", '"'], ["{symbolic}", ".", ",", "?", "!", "'", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  text_symbolic: [["[", "]", "{", "}", "#", "%", "^", "*", "+", "="], ["_", "\\", "|", "~", "<", ">", "€", "£", "¥", "•"], ["{numeric}", ".", ",", "?", "!", "'", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  search_alphabetic: [["й", "ц", "у", "к", "е", "н", "г", "ш", "щ", "з", "х", "ъ"], ["ф", "ы", "в", "а", "п", "р", "о", "л", "д", "ж", "э"], ["{shift}", "я", "ч", "с", "м", "и", "т", "ь", "б", "ю", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  search_shift: [["Й", "Ц", "У", "К", "Е", "Н", "Г", "Ш", "Щ", "З", "Х", "Ъ"], ["Ф", "Ы", "В", "А", "П", "Р", "О", "Л", "Д", "Ж", "З"], ["{shift}", "Я", "Ч", "С", "М", "И", "Т", "Ь", "Б", "Ю", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  search_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["-", "/", ":", ";", "(", ")", "$", "&", "@", '"'], ["{symbolic}", ".", ",", "?", "!", "'", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  search_symbolic: [["[", "]", "{", "}", "#", "%", "^", "*", "+", "="], ["_", "\\", "|", "~", "<", ">", "€", "£", "¥", "•"], ["{numeric}", ".", ",", "?", "!", "'", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  email_alphabetic: [["й", "ц", "у", "к", "е", "н", "г", "ш", "щ", "з", "х", "ъ"], ["ф", "ы", "в", "а", "п", "р", "о", "л", "д", "ж", "э"], ["{shift}", "я", "ч", "с", "м", "и", "т", "ь", "б", "ю", "{backspace}"], ["{numeric}", "@", "{space}", ".", "{done}"]],
  email_shift: [["Й", "Ц", "У", "К", "Е", "Н", "Г", "Ш", "Щ", "З", "Х", "Ъ"], ["Ф", "Ы", "В", "А", "П", "Р", "О", "Л", "Д", "Ж", "З"], ["{shift}", "Я", "Ч", "С", "М", "И", "Т", "Ь", "Б", "Ю", "{backspace}"], ["{numeric}", "@", "{space}", ".", "{done}"]],
  email_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["$", "!", "~", "&", "=", "#", "[", "]"], ["{symbolic}", ".", "_", "-", "+", "{backspace}"], ["{alphabetic}", "@", "{space}", ".", "{done}"]],
  email_symbolic: [["`", "|", "{", "}", "?", "%", "^", "*", "/", "'"], ["$", "!", "~", "&", "=", "#", "[", "]"], ["{numeric}", ".", "_", "-", "+", "{backspace}"], ["{alphabetic}", "@", "{space}", ".", "{done}"]],
  url_alphabetic: [["й", "ц", "у", "к", "е", "н", "г", "ш", "щ", "з", "х", "ъ"], ["ф", "ы", "в", "а", "п", "р", "о", "л", "д", "ж", "э"], ["{shift}", "я", "ч", "с", "м", "и", "т", "ь", "б", "ю", "{backspace}"], ["{numeric}", "/", ".ru", ".", "{done}"]],
  url_shift: [["Й", "Ц", "У", "К", "Е", "Н", "Г", "Ш", "Щ", "З", "Х", "Ъ"], ["Ф", "Ы", "В", "А", "П", "Р", "О", "Л", "Д", "Ж", "З"], ["{shift}", "Я", "Ч", "С", "М", "И", "Т", "Ь", "Б", "Ю", "{backspace}"], ["{numeric}", "/", ".ru", ".", "{done}"]],
  url_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["@", "&", "%", "?", ",", "=", "[", "]"], ["{symbolic}", "_", ":", "-", "+", "{backspace}"], ["{alphabetic}", "/", ".ru", ".", "{done}"]],
  url_symbolic: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["*", "$", "#", "!", "'", "^", "[", "]"], ["{numeric}", "~", ";", "(", ")", "{backspace}"], ["{alphabetic}", "/", ".ru", ".", "{done}"]],
  numeric_default: [["1", "2", "3"], ["4", "5", "6"], ["7", "8", "9"], ["0", "{backspace}"]],
  decimal_default: [["1", "2", "3"], ["4", "5", "6"], ["7", "8", "9"], [".", "0", "{backspace}"]],
  tel_default: [["1", "2", "3", "*"], ["4", "5", "6", "#"], ["7", "8", "9", "+"], ["0", "{backspace}"]]
};
...
var layouts = {
  text_alphabetic: [["q", "w", "e", "r", "t", "y", "u", "i", "o", "p", "å"], ["a", "s", "d", "f", "g", "h", "j", "k", "l", "ö", "ä"], ["{shift}", "z", "x", "c", "v", "b", "n", "m", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  text_shift: [["Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "Å"], ["A", "S", "D", "F", "G", "H", "J", "K", "L", "Ö", "Ä"], ["{shift}", "Z", "X", "C", "V", "B", "N", "M", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  text_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["-", "/", ":", ";", "(", ")", "$", "&", "@", '"'], ["{symbolic}", ".", ",", "?", "!", "'", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  text_symbolic: [["[", "]", "{", "}", "#", "%", "^", "*", "+", "="], ["_", "\\", "|", "~", "<", ">", "€", "£", "¥", "•"], ["{numeric}", ".", ",", "?", "!", "'", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  search_alphabetic: [["q", "w", "e", "r", "t", "y", "u", "i", "o", "p", "å"], ["a", "s", "d", "f", "g", "h", "j", "k", "l", "ö", "ä"], ["{shift}", "z", "x", "c", "v", "b", "n", "m", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  search_shift: [["Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "Å"], ["A", "S", "D", "F", "G", "H", "J", "K", "L", "Ö", "Ä"], ["{shift}", "Z", "X", "C", "V", "B", "N", "M", "{backspace}"], ["{numeric}", "{space}", "{done}"]],
  search_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["-", "/", ":", ";", "(", ")", "$", "&", "@", '"'], ["{symbolic}", ".", ",", "?", "!", "'", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  search_symbolic: [["[", "]", "{", "}", "#", "%", "^", "*", "+", "="], ["_", "\\", "|", "~", "<", ">", "€", "£", "¥", "•"], ["{numeric}", ".", ",", "?", "!", "'", "{backspace}"], ["{alphabetic}", "{space}", "{done}"]],
  email_alphabetic: [["q", "w", "e", "r", "t", "y", "u", "i", "o", "p", "å"], ["a", "s", "d", "f", "g", "h", "j", "k", "l", "ö", "ä"], ["{shift}", "z", "x", "c", "v", "b", "n", "m", "{backspace}"], ["{numeric}", "@", "{space}", ".", "{done}"]],
  email_shift: [["Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "Å"], ["A", "S", "D", "F", "G", "H", "J", "K", "L", "Ö", "Ä"], ["{shift}", "Z", "X", "C", "V", "B", "N", "M", "{backspace}"], ["{numeric}", "@", "{space}", ".", "{done}"]],
  email_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["$", "!", "~", "&", "=", "#", "[", "]"], ["{symbolic}", ".", "_", "-", "+", "{backspace}"], ["{alphabetic}", "@", "{space}", ".", "{done}"]],
  email_symbolic: [["`", "|", "{", "}", "?", "%", "^", "*", "/", "'"], ["$", "!", "~", "&", "=", "#", "[", "]"], ["{numeric}", ".", "_", "-", "+", "{backspace}"], ["{alphabetic}", "@", "{space}", ".", "{done}"]],
  url_alphabetic: [["q", "w", "e", "r", "t", "y", "u", "i", "o", "p", "å"], ["a", "s", "d", "f", "g", "h", "j", "k", "l", "ö", "ä"], ["{shift}", "z", "x", "c", "v", "b", "n", "m", "{backspace}"], ["{numeric}", "/", ".com", ".", "{done}"]],
  url_shift: [["Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "Å"], ["A", "S", "D", "F", "G", "H", "J", "K", "L", "Ö", "Ä"], ["{shift}", "Z", "X", "C", "V", "B", "N", "M", "{backspace}"], ["{numeric}", "/", ".com", ".", "{done}"]],
  url_numeric: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["@", "&", "%", "?", ",", "=", "[", "]"], ["{symbolic}", "_", ":", "-", "+", "{backspace}"], ["{alphabetic}", "/", ".com", ".", "{done}"]],
  url_symbolic: [["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], ["*", "$", "#", "!", "'", "^", "[", "]"], ["{numeric}", "~", ";", "(", ")", "{backspace}"], ["{alphabetic}", "/", ".com", ".", "{done}"]],
  numeric_default: [["1", "2", "3"], ["4", "5", "6"], ["7", "8", "9"], ["0", "{backspace}"]],
  decimal_default: [["1", "2", "3"], ["4", "5", "6"], ["7", "8", "9"], [".", "0", "{backspace}"]],
...
var NGX_TOUCH_KEYBOARD_LOCALE = new InjectionToken("NGX_TOUCH_KEYBOARD_LOCALE", {
  providedIn: "root",
...
var NgxTouchKeyboardComponent = class _NgxTouchKeyboardComponent {
  constructor() {
  ...
  setActiveInput(input2) {
    this._activeInputElement = input2;
  ...
  handleButtonPress(button, e) {
    ...
    let output2 = this._activeInputElement?.value || "";
    if (!this.isStandardButton(button)) {
      if (button === fnButton.BACKSPACE) {
        output2 = this._removeAt(output2, ...commonParams);
      } else if (button === fnButton.SPACE) {
        output2 = this._addStringAt(output2, " ", ...commonParams);
      } else if (button === fnButton.TAB) {
        output2 = this._addStringAt(output2, "	", ...commonParams);
      } else if (button === fnButton.ENTER) {
        if (this.isTextarea) {
          output2 = this._addStringAt(output2, "\n", ...commonParams);
        }
      } else {
      ...
      output2 = this._addStringAt(output2, button, ...commonParams);
    }
    if (this._activeInputElement) {
      this._activeInputElement.value = output2;
      if (this.debug) {
  ...
  handleButtonDown(button, e) {
    ...
    this._holdTimeout = window.setTimeout(() => {
      if (this._isMouseHold && (!button.includes("{") && !button.includes("}") || button === fnButton.BACKSPACE || button === fnButton.SPACE)) {
        if (this.debug) {
  ...
  _removeAt(source, position = source.length, positionEnd = source.length, moveCaret = false) {
    ...
    if (position === positionEnd) {
      ...
      if (position && position >= 0) {
        ...
        if (emojiMatched) {
          output2 = source.substr(0, position - 2) + source.substr(position);
          if (moveCaret) this._updateCaretPos(2, true);
        } else {
          output2 = source.substr(0, position - 1) + source.substr(position);
        ...
        emojiMatched = prevTwoChars.match(emojiMatchedReg);
        if (emojiMatched) {
          output2 = source.slice(0, -2);
          if (moveCaret) this._updateCaretPos(2, true);
        } else {
          output2 = source.slice(0, -1);
          if (moveCaret) this._updateCaretPos(1, true);
        }
      }
    } else {
      output2 = source.slice(0, position) + source.slice(positionEnd);
      if (moveCaret) {
  ...
  _addStringAt(source, str, position = source.length, positionEnd = source.length, moveCaret = false) {
    ...
    if (!position && position !== 0) {
      ...
      output2 = [source.slice(0, position), str, source.slice(positionEnd)].join("");
  ...
  _dispatchEvents(button) {
    ...
    this._activeInputElement?.dispatchEvent(new Event("input", {
      bubbles: true
    }));
  ...
  _caretEventHandler(event) {
    ...
    const isTextInput = targetTagName === "textarea" || targetTagName === "input" && ["text", "search", "email", "password", "url", "tel"].includes(event.target.type);
    const isKeyboard = event.target === this._elementRef.nativeElement || event.target && this._elementRef.nativeElement.contains(event.target);
  ...
  _getKeyboardLayoutKey(event) {
    ...
    if (keyId?.includes("Space") || keyId?.includes("Numpad") || keyId?.includes("Backspace") || keyId?.includes("CapsLock") || keyId?.includes("Meta")) {
      output2 = `{${event.code}}` || "";
    ...
    return output2.length > 1 ? output2?.toLowerCase() : output2;
  }
  /**
  ...
  static {
    this.ɵfac = function NgxTouchKeyboardComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NgxTouchKeyboardComponent)();
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
      type: _NgxTouchKeyboardComponent,
      selectors: [["ngx-touch-keyboard"]],
      hostBindings: function NgxTouchKeyboardComponent_HostBindings(rf, ctx) {
        if (rf & 1) {
          ɵɵlistener("keyup", function NgxTouchKeyboardComponent_keyup_HostBindingHandler($event) {
            return ctx.handleKeyUp($event);
          }, false, ɵɵresolveWindow)("keydown", function NgxTouchKeyboardComponent_keydown_HostBindingHandler($event) {
            return ctx.handleKeyDown($event);
          }, false, ɵɵresolveWindow)("pointerup", function NgxTouchKeyboardComponent_pointerup_HostBindingHandler($event) {
            return ctx.handleMouseUp($event);
          }, false, ɵɵresolveWindow)("select", function NgxTouchKeyboardComponent_select_HostBindingHandler($event) {
            return ctx.handleSelect($event);
          }, false, ɵɵresolveWindow)("selectionchange", function NgxTouchKeyboardComponent_selectionchange_HostBindingHandler($event) {
      ...
      decls: 3,
      vars: 1,
      consts: [[1, "touch-keyboard", 3, "ngClass"], [1, "touch-keyboard-row"], [1, "touch-keyboard-key", 3, "name", "dir", "ngClass", "innerHtml"], [1, "touch-keyboard-key", 3, "pointerup", "pointerdown", "pointercancel", "name", "dir", "ngClass", "innerHtml"]],
      template: function NgxTouchKeyboardComponent_Template(rf, ctx) {
        if (rf & 1) {
          ɵɵelementStart(0, "div", 0);
          ɵɵrepeaterCreate(1, NgxTouchKeyboardComponent_For_2_Template, 3, 0, "div", 1, _forTrack0);
          ɵɵelementEnd();
        }
        if (rf & 2) {
          ɵɵproperty("ngClass", "layout-" + ctx.layoutMode + "-" + ctx.layoutName);
          ɵɵadvance();
          ɵɵrepeater(ctx.locale.layouts[ctx.layoutMode + "_" + ctx.layoutName]);
        }
      },
      dependencies: [NgClass, Dir],
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NgxTouchKeyboardComponent, [{
    type: Component,
    args: [{
      selector: "ngx-touch-keyboard",
      encapsulation: ViewEncapsulation$1.None,
      changeDetection: ChangeDetectionStrategy.OnPush,
      template: `<div class="touch-keyboard" [ngClass]="'layout-' + layoutMode + '-' + layoutName">\r
  @for (row of locale.layouts[layoutMode + '_' + layoutName]; track row[0]; let rowIndex = $index) {\r
  <div class="touch-keyboard-row">\r
    @for (key of row; track key) {\r
    <button\r
      [name]="key"\r
      [dir]="locale.dir"\r
      class="touch-keyboard-key"\r
      [ngClass]="[getButtonClass(key)]"\r
      [attr.data-layout]="layoutMode"\r
      (pointerup)="handleButtonUp(key, $event)"\r
      (pointerdown)="handleButtonDown(key, $event)"\r
      (pointercancel)="handleButtonUp(key, $event)"\r
      [innerHtml]="getButtonDisplayName(key)"\r
    ></button>\r
    }\r
  </div>\r
  }\r
...
var NgxTouchKeyboardOrigin = class _NgxTouchKeyboardOrigin {
  constructor() {
    this.elementRef = inject(ElementRef);
  }
  static {
    this.ɵfac = function NgxTouchKeyboardOrigin_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NgxTouchKeyboardOrigin)();
    };
  }
  static {
    this.ɵdir = ɵɵdefineDirective({
      type: _NgxTouchKeyboardOrigin,
      selectors: [["", "ngxTouchKeyboardOrigin", ""]],
      exportAs: ["ngxTouchKeyboardOrigin"]
    });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NgxTouchKeyboardOrigin, [{
    type: Directive,
    args: [{
...
var NgxTouchKeyboardDirective = class _NgxTouchKeyboardDirective {
  /**
   * constructor
   */
  constructor() {
  ...
  _getPositionStrategy(fullscreen) {
    ...
    return this._overlay.position().flexibleConnectedTo(this._getOriginElement()).withLockedPosition().withPush().withPositions([{
      originX: "start",
      originY: "bottom",
      overlayX: "start",
      overlayY: "top"
  ...
  static {
    this.ɵfac = function NgxTouchKeyboardDirective_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NgxTouchKeyboardDirective)();
    };
  }
  static {
    this.ɵdir = ɵɵdefineDirective({
      type: _NgxTouchKeyboardDirective,
      selectors: [["input", "ngxTouchKeyboard", ""], ["textarea", "ngxTouchKeyboard", ""]],
      inputs: {
        open: [1, "ngxTouchKeyboardOpen", "open"],
        locale: [1, "ngxTouchKeyboardLocale", "locale"],
        debugMode: [1, "ngxTouchKeyboardDebug", "debugMode"],
        fullScreenMode: [1, "ngxTouchKeyboardFullScreen", "fullScreenMode"],
        origin: [1, "ngxConnectedTouchKeyboardOrigin", "origin"]
      },
      outputs: {
        open: "ngxTouchKeyboardOpenChange"
      },
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NgxTouchKeyboardDirective, [{
    type: Directive,
    args: [{
...
var NgxTouchKeyboardModule = class _NgxTouchKeyboardModule {
  static {
    this.ɵfac = function NgxTouchKeyboardModule_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NgxTouchKeyboardModule)();
    };
  }
  static {
    this.ɵmod = ɵɵdefineNgModule({
      type: _NgxTouchKeyboardModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NgxTouchKeyboardModule, [{
    type: NgModule,
    args: [{
      imports: [NgClass, PortalModule, OverlayModule],
      declarations: [NgxTouchKeyboardOrigin, NgxTouchKeyboardDirective, NgxTouchKeyboardComponent],
...
export {
  NGX_TOUCH_KEYBOARD_LOCALE,
  NGX_TOUCH_KEYBOARD_LOCALE_FACTORY,
...
//# sourceMappingURL=ngx-touch-keyboard.js.map
